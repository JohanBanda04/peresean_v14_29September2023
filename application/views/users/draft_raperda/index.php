                ...
                <div class="panel-body">
                    <?php if ($_SESSION['level']!="perancang"){ ?>
                        <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?= $link3; ?>/t.html" class="btn btn-primary"><i
                                    class="fa fa-plus-circle"></i> sTambah Dokumensz</a>
                        <!--                            --><?//= $zona_document; ?>
...
<!--                                        </a>-->
                                        ...
                                        if($_SESSION['level']!="perancang"){ ?>
                                            <a title="Edited By Pemdaa " href="pemda/draft/<?= $link3; ?>/ce/<?= hashids_encrypt($baris->id_draft_permohonan);?>"
                                                <?php if($baris->nama_perancang!=""){
                                                    if($_SESSION['level']=="superadmin") { ?>
                                        ...
                                        <a title="Edit Kasub Perancang" href="pemda/draft/<?= $link3; ?>/ce_kasub_perancang/<?= hashids_encrypt($baris->id_draft_permohonan);?>"
                                            <?php if ($_SESSION['level']=='kasub_perancang') { ?> class="btn btn-warning btn-xs" <?php } else if($_SESSION['level']=='superadmin'){ ?> class="btn btn-warning btn-xs" <?php } else { ?> class="hidden btn btn-success btn-xs" <?php } ?> >
                                            <i class="fa fa-edit"></i>
                                        </a>
